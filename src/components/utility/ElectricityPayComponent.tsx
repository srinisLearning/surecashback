          ...
          >
            <div className="mb-4">
              ...
              >
                ...
                <option value="2">Tamil Nadu Electricity Board (TNEB)</option>
                <option value="3">Tata Power - Mumbai</option>
                <option value="4">
                  Thrissur Corporation Electricity Department
                </option>
                <option value="5">BSES Rajdhani Power Limited</option>
              </select>
            </div>
...
export default ElectricityPayComponent;
